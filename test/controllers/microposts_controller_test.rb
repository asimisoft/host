...
class MicropostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create micropost" do
    assert_difference('Micropost.count') do
      post microposts_url, params: { micropost: { email: @micropost.email, name: @micropost.name } }
    end
  ...
  test "should update micropost" do
    patch micropost_url(@micropost), params: { micropost: { email: @micropost.email, name: @micropost.name } }
